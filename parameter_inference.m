%% Compare the stHMM and HMM for parameter inference
...
%% Add panel names to the figure. NOTE: first save figures above.
...
%% Extra: produce figure of marginalised posterior
...
idxExp = 1; % choose data set of interest
