...
% Plot all the parameter positions in real space
% convert positions from uniform space to normal space
% yVecTr = pointArr;
% for k = 1:nPoints
%     for idx = 1:4
%         if strcmp(priorPars{idx,1},'uniform')
%             yVecTr(k,idx) = unifinv(pointArr(k,idx),priorPars{idx,2},priorPars{idx,3});
%         elseif strcmp(priorPars{idx,1},'lognormal')
%             yVecTr(k,idx) = logninv(pointArr(k,idx),priorPars{idx,2},priorPars{idx,3});
%         end                
%     end
% end
