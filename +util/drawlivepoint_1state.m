function [uposNew, logLnew, posNew, reject] = drawlivepoint_1state(livePoints, logLworst, exPars, data, priorPars, loglfun)
    ...
    % Preliminaries
    pointArr = reshape([livePoints.upos],1,[])'; % numerical array of all live points' positions
